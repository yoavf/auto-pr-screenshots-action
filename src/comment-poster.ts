...
export async function postComment(
  ...
  try {
    ...
    const commentBody = generateCommentBody(screenshots, context, config);
...
function generateCommentBody(
  ...
  body += `*Generated by [Auto PR Screenshots](https://github.com/yoavfarhi/auto-pr-screenshots) • [View Run](${runUrl})*`;
